...
#______Installing Consul____________
resource "null_resource" "provisioning" {
 ...
 null_resource.kubectl_awsauth,
  ...
  provisioner "local-exec" { 
     command = "bash ./script/provisioner.sh"
  }
 #before destroying, run "helm delete consul && helm reset" to delete tiller and terraform destroy everything properly 
  }
